...
insert into TextBook values(747218, "DBMS", "Henry Publications", "Henry");
insert into BookAdoption values(001, 7, 747218);
...
DELIMITER //
create trigger preventStudent
before insert on Enroll
for each row 
BEGIN 
    if (new.marks<40) then
        signal sqlstate '45000' set message_text='Marks is below required ask.';
    end if;
end;
